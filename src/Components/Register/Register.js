...
const Register = ({ imageUrl, box, onRouteChange }) => {
  return (
        ...
        <div className="measure">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            ...
            <div className="mt3">
              ...
              <input
                className="pa2 input-reset ba  hover-bg-white hover-white w-100"
                type="text"
                name="name"
                id="name"
              />
            ...
            <div className="mv3">
              ...
              <input
                className="b pa2 input-reset ba hover-bg-white hover-white w-100"
                type="password"
                name="password"
                id="password"
              />
